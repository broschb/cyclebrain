...
<!-- Begin
function validatePwd(pfield, vfield,infofield) {
...
if (pw1 == '' || pw2 == '') {
 msg (infofield, "error", "Please enter your password twice.");
 setfocus(pfield);
return false;
}
// check for minimum length
if (pfield.value.length < minLength) {
msg (infofield, "error", 'Your password must be at least ' + minLength + ' characters long. Try again.');
setfocus(pfield);
return false;
}
// check for spaces
if (pfield.value.indexOf(invalid) > -1) {
alert("Sorry, spaces are not allowed.");
msg (infofield, "error", "Sorry, spaces are not allowed.");
setfocus(pfield);
return false;
}
else {
if (pw1 != pw2) {
msg (infofield, "error", "You did not enter the same new password twice. Please re-enter your password.");
setfocus(pfield);
return true;
}
else {
