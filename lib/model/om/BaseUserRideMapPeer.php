...
abstract class BaseUserRideMapPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserRideId', 'CoordOrder', 'Lat', 'Long', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userRideId', 'coordOrder', 'lat', 'long', ),
		BasePeer::TYPE_COLNAME => array (self::USER_RIDE_ID, self::COORD_ORDER, self::LAT, self::LONG, ),
		BasePeer::TYPE_FIELDNAME => array ('user_ride_id', 'coord_order', 'lat', 'long', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserRideId' => 0, 'CoordOrder' => 1, 'Lat' => 2, 'Long' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userRideId' => 0, 'coordOrder' => 1, 'lat' => 2, 'long' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::USER_RIDE_ID => 0, self::COORD_ORDER => 1, self::LAT => 2, self::LONG => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('user_ride_id' => 0, 'coord_order' => 1, 'lat' => 2, 'long' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doValidate(UserRideMap $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(UserRideMapPeer::DATABASE_NAME, UserRideMapPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = UserRideMapPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
